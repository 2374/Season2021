        ...
        while (distance < path.getLength()) {
            ...
            if (MathUtils.epsilonEquals(optimalAcceleration, 0.0)) {
                ...
                for (TrajectoryConstraint constraint : trajectoryConstraints) {
                    ...
                    maxEndingAcceleration = Math.min(constraint. getMaxAcceleration(endingState, startingVelocity), maxEndingAcceleration); // TO DO: Use endingVelocity instead of startingVelocity
                }
