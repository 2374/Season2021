...
public abstract class SwerveModule {
     ...
     *
     * TO DO: Allow implementors to specify the current velocity without overriding this method.
     ...
     *
     * TO DO: Allow implementors to specify current draw without overriding this method.
    ...
    public SwerveModuleState getState() {
        Rotation2d rotation = new Rotation2d(getCurrentAngle());
        SwerveModuleState sms = new SwerveModuleState(getCurrentVelocity(), rotation);
        return sms;
    }
}